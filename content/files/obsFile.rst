...
Each row in the array contains the elements of the impedance tensor at a particular location separated into real and imaginary components, along with the corresponding uncertainties. The units for MT data are (V/A). `Download MT data example <https://github.com/ubcgif/e3dmt/raw/e3dmt/assets/MT_data.dat>`__ . The columns for this data format are as follows:
